...
public class DELETERECORD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ENTER DOCTORS ID");
...
try {  
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital","root","Shriram@11");
        Statement statement = con.createStatement();  
        statement.executeUpdate("DELETE FROM doctor WHERE DOCTOR_ID=" + jTextField1.getText());  
